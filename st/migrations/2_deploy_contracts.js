...
module.exports = function (deployer, network, accounts) {
  ...
  return deployer.deploy(ModuleRegistry, {from: PolymathAccount}).then(() => {
    ...
    return deployer.deploy(TickerRegistry, PolyToken, 0, {from: PolymathAccount})
    }).then(() => {
    ...
    return deployer.deploy(SecurityTokenRegistry, PolyToken, ModuleRegistry.address, TickerRegistry.address, STVersionProxy001.address, 0, {from: PolymathAccount})
    }).then(() => {
